...
class _OrderRepository implements OrderRepository {
  _OrderRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<void> createOrder(Map<String, dynamic> json) async {
  ...
  @override
  Future<void> cancelCompletedOrder({required int orderId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<List<OrderModel>> getOrderList() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<OrderModel>>(
